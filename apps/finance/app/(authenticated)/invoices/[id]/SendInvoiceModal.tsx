  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 text-sm bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 rounded-lg transition-colors border border-blue-500/20"
      >
