...
function CasesContent() {
    ...
    useEffect(() => {
        ...
        filtered = filtered.filter(c => {
            ...
            // Use primary project if set, otherwise fall back to first project
            const primaryProjectId = c.projects.find((p: any) => p.isPrimary)?.project.id
                || c.projects[0]?.project.id;
