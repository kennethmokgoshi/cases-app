                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <button
                                        ...
                                        className={`flex-1 min-w-[80px] py-2 px-3 rounded-lg font-medium transition-colors text-sm ${formData.role === 'MEMBER'
                                            ? 'bg-blue-500 text-white'
                                            : 'bg-zeno-blue/30 text-gray-300 hover:bg-zeno-blue/50'
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 min-w-[80px] py-2 px-3 rounded-lg font-medium transition-colors text-sm ${formData.role === 'MANAGER'
                                            ? 'bg-blue-500 text-white'
                                            : 'bg-zeno-blue/30 text-gray-300 hover:bg-zeno-blue/50'
                                            }`}
                                    >
                                    ...
                                    {/* Additional Roles for Staff Only */}
                                    {formData.userType === 'STAFF' && (
                                        <>
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => setFormData({ ...formData, role: 'FINANCE' })}
                                                className={`flex-1 min-w-[80px] py-2 px-3 rounded-lg font-medium transition-colors text-sm ${formData.role === 'FINANCE'
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 min-w-[80px] py-2 px-3 rounded-lg font-medium transition-colors text-sm ${formData.role === 'ADMIN'
