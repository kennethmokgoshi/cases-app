...
export default function AdminDashboard() {
    ...
    const adminModules = [
            ...
            color: 'from-violet-500 to-purple-500' },
        {
            ...
            description: 'Turn satisfied clients into referrers — preserving their referral chain',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
            ),
            href: '/admin/convert-clients',
            color: 'from-indigo-500 to-violet-500' },
        {
            title: 'Conversion Report',
            description: 'Track converted clients & their referral performance metrics',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
            ),
            href: '/admin/referrer-conversion-report',
            color: 'from-cyan-500 to-blue-500' },
        {
            title: 'Deleted Files',
            description: 'View and restore deleted cases. Files are permanently removed after 30 days.',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            color: 'from-red-600 to-rose-500' },
        {
            ...
            description: 'Inbound client messages that have not received a reply within the threshold',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
