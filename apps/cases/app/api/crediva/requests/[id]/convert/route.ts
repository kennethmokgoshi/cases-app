  ...
  try {
    ...
    const newCase = await prisma.case.create({
      data: {
        ...
        clientId: clientId!,
        status: "NEW_LEAD",
        description: `Crediva Request: ${services.join(", ")}`,
    ...
    await prisma.caseComment.create({
      data: {
        caseId: newCase.id,
        content: `Case automatically created from Crediva Service Request #${requestId}.`,
    ...
    console.error("[Crediva Conversion Error]", error);
