...
import { markCredivaBrowserSession } from "@/lib/session-security";
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", textDecoration: "none", position: "relative" }}>
          <img src="/logo-white.png" alt="Crediva" style={{ height: 44, width: "auto" }} />
        </Link>
