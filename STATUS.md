...
> Last updated: 2026-07-04 (**Debt review removal consent wording clarified**: Credo and fallback consent pages now explain that the approval confirms Zenowethu Debt Management is the debt counsellor authorised to work on the file, creating a clear record before the team continues. Pending consent links now display and stamp the clarified wording while already-consented records keep their historical wording. Focused Vitest: shared-lib consent-service 13/13 green; Credo consent route 9/9 green.)
