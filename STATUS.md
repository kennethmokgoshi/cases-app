...
**Migration added:** `packages/database/prisma/migrations/20260818120000_add_payment_instalment_allocation` — additive only (one nullable column, one index, one FK). **Not yet applied to production.**
