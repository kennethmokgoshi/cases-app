    ...
    return (
        <div>
            ...
            <ul className="space-y-1">
                ...
                <li>
                    <SmartLink href="/reports/xds-sync" className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${pathname.startsWith('/reports/xds-sync') ? 'bg-zeno-cyan/10 text-zeno-cyan' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
